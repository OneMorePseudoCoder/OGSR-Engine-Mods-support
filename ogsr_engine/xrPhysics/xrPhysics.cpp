...
static void* ode_alloc(size_t size) { return xr_malloc(size, "ODE"); }
static void* ode_realloc(void* ptr, size_t oldsize, size_t newsize) { return xr_realloc(ptr, newsize, "ODE"); }
