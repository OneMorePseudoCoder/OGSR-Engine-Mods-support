...
public:
    ...
    //	virtual		void			get_LinearVel							(Fvector& velocity) const = 0; 	virtual		void			get_AngularVel
    //(Fvector& velocity)	const																								= 0;
...
public:
    ...
    //{ get_LinearVel( velocity ); } 	virtual			void						get_AngularVel							( Fvector& velocity )		const
