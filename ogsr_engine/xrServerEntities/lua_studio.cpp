...
int engine::lua_sethook(lua_State* L, lua_Hook func, lua_mask_type mask, int count) { return (::lua_sethook(L, func, mask, count)); }
...
int engine::lua_pcall(lua_State* L, int nargs, int nresults, int errfunc) { return (::lua_pcall(L, nargs, nresults, errfunc)); }
...
void engine::fill_class_info(cs::lua_studio::backend& backend, char* const buffer, unsigned int const size, luabind::detail::object_rep* object,
...
void engine::value_convert_class(cs::lua_studio::backend& backend, char* buffer, unsigned int size, luabind::detail::class_rep* class_rep, lua_State* state, int index,
...
bool engine::value_convert_instance(cs::lua_studio::backend& backend, char* buffer, unsigned int size, lua_State* state, int index, cs::lua_studio::icon_type& icon_type,
...
bool engine::value_to_string(cs::lua_studio::backend& backend, char* const buffer, unsigned int const size, lua_State* const state, int const index,
                             cs::lua_studio::icon_type& icon_type, bool const full_description)
{
    switch (lua_type(state, index))
    {
