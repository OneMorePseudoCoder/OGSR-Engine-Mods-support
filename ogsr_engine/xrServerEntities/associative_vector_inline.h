...
IC u32 _associative_vector::size() const { return ((u32)inherited::size()); }
...
TEMPLATE_SPECIALIZATION
IC bool _associative_vector::operator<=(const self_type& right) const { return !(right < ((const inherited&)(*this))); }
