...
public:
    ...
    IC const key_type& key_at(size_type index) const { return inherited::operator[](index).first; }
    IC mapped_type& value_at(size_type index) { return inherited::operator[](index).second; }
    IC const mapped_type& value_at(size_type index) const { return inherited::operator[](index).second; }
    IC const value_type& at(size_type index) const { return inherited::operator[](index); }
    IC value_type& at(size_type index) { return inherited::operator[](index); }
