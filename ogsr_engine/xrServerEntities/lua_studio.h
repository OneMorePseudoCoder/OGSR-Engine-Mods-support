...
public:
    ...
    virtual bool CS_LUA_STUDIO_BACKEND_CALL value_to_string(cs::lua_studio::backend& backend, char* buffer, unsigned int size, lua_State* state, int index,
...
private:
    void fill_class_info(cs::lua_studio::backend& backend, char* buffer, unsigned int size, luabind::detail::object_rep* object, luabind::detail::class_rep* class_rep,
                         lua_State* state);
    void value_convert_class(cs::lua_studio::backend& backend, char* buffer, unsigned int size, luabind::detail::class_rep* class_rep, lua_State* state, int index,
                             cs::lua_studio::icon_type& icon_type, bool full_description);
    ...
    bool value_convert_instance(cs::lua_studio::backend& backend, char* buffer, unsigned int size, lua_State* state, int index, cs::lua_studio::icon_type& icon_type,
