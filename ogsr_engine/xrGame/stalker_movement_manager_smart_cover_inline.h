...
IC void stalker_movement_manager_smart_cover::property_storage(CPropertyStorage* storage) { m_property_storage = storage; }
...
IC void stalker_movement_manager_smart_cover::non_animated_loophole_change(bool const& value) { m_non_animated_loophole_change = value; }

IC float const& stalker_movement_manager_smart_cover::apply_loophole_direction_distance() const { return (m_apply_loophole_direction_distance); }

IC void stalker_movement_manager_smart_cover::apply_loophole_direction_distance(float const& value) { m_apply_loophole_direction_distance = value; }
...
IC bool stalker_movement_manager_smart_cover::entering_smart_cover_with_animation() const { return (m_entering_smart_cover_with_animation); }
