...
template <typename _data_type = std::monostate, typename _edge_weight_type = float, typename _vertex_id_type = u32, typename _edge_data_type = std::monostate>
...
template <typename _data_type = std::monostate, typename _edge_weight_type = float, typename _vertex_id_type = u32>
