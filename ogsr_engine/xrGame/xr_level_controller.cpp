...
xr_vector<_action> actions = {
    ...
    DEF_ACTION("show_detector", kDETECTOR)
    ...
    {nullptr, kLASTACTION, "kLASTACTION"},
};
...
public:
    ...
    virtual void Save(IWriter* F)
    {
        ...
        //Заменено потому что у нас в двиге в execUserScript() вызывается unbindall. Возможно лучше там поправить на чн/зп манер чем тут, хз...
        //if (m_work_idx == 0)
...
public:
    ...
    virtual void Execute(LPCSTR args)
    {
        ...
        // Добавлено потому что у нас в двиге в execUserScript() вызывается unbindall. Возможно лучше там поправить на чн/зп манер чем тут, хз...
        string_path _cfg;
        string_path cmd;
