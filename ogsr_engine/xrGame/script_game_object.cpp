...
BIND_FUNCTION01(&object(), CScriptGameObject::ChangeAlcohol, CActor, conditions().ChangeAlcohol, float, float);
...
u16 CScriptGameObject::get_bone_id(LPCSTR bone_name) const { return object().Visual()->dcast_PKinematics()->LL_BoneID(bone_name); }
