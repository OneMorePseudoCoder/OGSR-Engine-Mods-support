...
protected:
    ...
    // интервал между первыми выстрелами без нарастающей отдачи (GUNSLINGER Mod)
    float m_fBaseDispersionedBulletsTimeDelta;
    // интервал между выстрелами при стрельбе одиночными (GUNSLINGER Mod)
    ...
    // Использовать ли 2D гильзы в виде партиклов
    bool m_bUse2DShells;

public:
    virtual void OnZoomIn();
    virtual void OnZoomOut();
    void OnNextFireMode(bool opt = false);
    void OnPrevFireMode(bool opt = false);
