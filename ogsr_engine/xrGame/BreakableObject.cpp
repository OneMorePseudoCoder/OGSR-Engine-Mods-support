...
void CBreakableObject::CreateUnbroken() { m_pUnbrokenObject = P_BuildStaticGeomShell((this), BreakableObjectCollisionCallback); }
...
void CBreakableObject::ActivateBroken()
{
    ...
    K->CalculateBones(/*TRUE*/); // у нас нету тут true
