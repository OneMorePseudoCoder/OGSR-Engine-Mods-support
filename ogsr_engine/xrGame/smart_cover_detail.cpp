...
bool smart_cover::detail::parse_float(float& output, luabind::object const& table, LPCSTR identifier, float const& min_threshold, float const& max_threshold)
{
    ...
    if (lua_result.type() == LUA_TNUMBER)
    {
