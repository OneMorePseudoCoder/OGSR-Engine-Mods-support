...
void CALifeSimulator::script_register(lua_State* L)
{
    module(L)[class_<CALifeSimulator>("alife_simulator")
                  ...
                  .def("change_actor_level",
                       [](CALifeSimulator*, const Fvector3& position, const u32 level_vertex_id, const GameGraph::_GRAPH_ID game_graph_id, const Fvector3& dir) {
                           NET_Packet P;
                  ...
                  .def("teleport_object", [](CALifeSimulator* self, u16 ID, const Fvector& _pos, u32 _lvid, GameGraph::_GRAPH_ID _gvid) { self->teleport_object(ID, _gvid, _lvid, _pos); })
                  ,
              def("alife", &alife)];
