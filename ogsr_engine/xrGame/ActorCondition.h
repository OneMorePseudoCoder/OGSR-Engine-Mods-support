...
public:
    ...
    float V_Satiety() const { return m_fV_Satiety; }
    float V_SatietyPower() const { return m_fV_SatietyPower; }
    float V_SatietyHealth() const { return m_fV_SatietyHealth; }
    float SatietyCritical() const { return m_fSatietyCritical; }

    float V_Thirst() const { return m_fV_Thirst; }
    float V_ThirstPower() const { return m_fV_ThirstPower; }
    float V_ThirstHealth() const { return m_fV_ThirstHealth; }
