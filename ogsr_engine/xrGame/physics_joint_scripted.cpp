    ...
    module(
        L)[class_<cphysics_joint_scripted>("physics_joint")
               ...
               .def("set_axis_dir_vs_first_element",
                    (void (cphysics_joint_scripted::*)(const float, const float, const float, const int))(&cphysics_joint_scripted::SetAxisDirVsFirstElement))
               .def("set_axis_dir_vs_second_element",
                    (void (cphysics_joint_scripted::*)(const float, const float, const float, const int))(&cphysics_joint_scripted::SetAxisDirVsSecondElement))
