...
void DBG_DrawTri(const Fvector& v0, const Fvector& v1, const Fvector& v2, u32 ac, bool solid) { DBG_DrawPHAbstruct(xr_new<SPHDBGDrawTri>(v0, v1, v2, ac, solid)); }
...
class cphdebug_impl : public IPhDebugRender
{
    ...
    void draw_tri(const Fvector& v0, const Fvector& v1, const Fvector& v2, u32 c, bool solid) { DBG_DrawTri(v0, v1, v2, c, solid); }
