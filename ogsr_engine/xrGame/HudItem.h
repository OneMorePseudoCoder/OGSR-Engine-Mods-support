...
protected:
    ...
    struct
    {
        ...
        //bool SprintType{};
        bool BobbingEnable{};
        //u32 m_dwStateTime{}; //тут не надо вроде б
    };
...
public:
    ...
    virtual bool MovingAnimAllowedNow() const { return true; } //SIMP:нелогичная функция
    virtual bool AnmIdleMovingAllowed() const; //а вот это норм функция c main ветки
