...
{
    auto* entity_alive = smart_cast<CEntityAlive*>(O);
    auto* pNewContactInvOwner = smart_cast<CInventoryOwner*>(O);
...
void CPda::feel_touch_delete(CObject* O)
{
    ...
    auto* entity_alive = smart_cast<CEntityAlive*>(O);
    auto* pLostContactInvOwner = smart_cast<CInventoryOwner*>(O);
