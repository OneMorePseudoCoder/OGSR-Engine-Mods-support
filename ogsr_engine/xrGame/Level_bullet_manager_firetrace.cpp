...
void CBulletManager::FireShotmark(SBullet* bullet, const Fvector& vDir, const Fvector& vEnd, collide::rq_result& R, u16 target_material, const Fvector& vNormal, bool ShowMark)
{
    ...
    ref_sound* pSound = (!mtl_pair || mtl_pair->CollideSounds.empty()) ? nullptr : &mtl_pair->CollideSounds[::Random.randI(0, (u32)mtl_pair->CollideSounds.size())];
...
void CBulletManager::DynamicObjectHit(CBulletManager::_event& E)
{
    ...
    if (E.bullet.flags.allow_sendhit && !E.Repeated)
    {
        ...
        SHit Hit = SHit(hit_param.power, original_dir, nullptr, u16(E.R.element), position_in_bone_space, hit_param.impulse, E.bullet.hit_type, E.bullet.armor_piercing,
