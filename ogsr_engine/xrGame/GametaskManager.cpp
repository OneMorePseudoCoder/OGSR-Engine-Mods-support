...
bool task_prio_pred(const SGameTaskKey& k1, const SGameTaskKey& k2) { return k1.game_task->m_priority > k2.game_task->m_priority; }
...
void CGameTaskManager::SetActiveTask(CGameTask* task)
{
    ...
    Discord.Set_active_task_text(CStringTable().translate(task ? task->m_Title : "st_no_active_task").c_str());
}
...
static const char* sTaskStates[] = {"eTaskStateFail", "TaskStateInProgress", "TaskStateCompleted", "TaskStateDummy"};
