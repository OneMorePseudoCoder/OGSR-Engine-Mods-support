...
monster_aura::monster_aura(CBaseMonster* const object, pcstr const name) : m_object(object), m_pp_effector_name(nullptr), m_pp_index(0)
{
...
{
    using namespace detail;
    VERIFY(override_if_debug(s_pp_highest_at_string, m_pp_highest_at) != 0.f);
