...
void CBaseMonster::Load(LPCSTR section)
{
    ...
    m_feel_enemy_who_just_hit_max_distance =
        READ_IF_EXISTS(pSettings, r_float, section, "feel_enemy_who_just_hit_max_distance", detail::base_monster::feel_enemy_who_just_hit_max_distance);
    ...
    m_feel_enemy_who_made_sound_max_distance =
        READ_IF_EXISTS(pSettings, r_float, section, "feel_enemy_who_made_sound_max_distance", detail::base_monster::feel_enemy_who_made_sound_max_distance);
...
void CBaseMonster::fill_bones_body_parts(LPCSTR body_part, CriticalWoundType wound_type)
{
    ...
    const auto& body_part_section = pSettings->r_section(body_parts_section);
