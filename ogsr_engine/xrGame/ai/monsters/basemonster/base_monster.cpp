...
float CBaseMonster::get_attack_on_move_max_go_close_time() { return override_if_debug("aom_max_go_close_time", m_attack_on_move_params.max_go_close_time); }
...
float CBaseMonster::get_attack_on_move_attack_radius() { return override_if_debug("aom_attack_radius", m_attack_on_move_params.attack_radius); }

float CBaseMonster::get_attack_on_move_update_side_period() { return override_if_debug("aom_update_side_period", m_attack_on_move_params.update_side_period); }

float CBaseMonster::get_attack_on_move_prediction_factor() { return override_if_debug("aom_prediction_factor", m_attack_on_move_params.prediction_factor); }

float CBaseMonster::get_attack_on_move_prepare_radius() { return override_if_debug("aom_prepare_radius", m_attack_on_move_params.prepare_radius); }

float CBaseMonster::get_attack_on_move_prepare_time() { return override_if_debug("aom_prepare_time", m_attack_on_move_params.prepare_time); }
