...
void ChimeraAttackState<Object>::execute()
{
    ...
    bool const can_prepare_jump = preparing_state && current_time() > m_last_jump_time + this->object->get_attack_params().prepare_jump_timeout;
    bool const can_attack_jump = !preparing_state && current_time() > m_last_jump_time + this->object->get_attack_params().attack_jump_timeout;
