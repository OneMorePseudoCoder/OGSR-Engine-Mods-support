...
{
    //add_state(eStateRest, xr_new<CStateGroupRest<CAI_Dog>>(monster)); // ЗП-шный вариант кривой, из-за него собаки часто занимаются ходьбой на одном месте и всё, другие состояния "отдыха" не работают.
