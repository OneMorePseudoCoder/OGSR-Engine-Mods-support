...
void CAI_Dog::Load(LPCSTR section)
{
    ...
    m_anim_factor = READ_IF_EXISTS(pSettings, r_u32, section, "anim_factor", 50);
    m_corpse_use_timeout = 1000 * READ_IF_EXISTS(pSettings, r_u32, section, "corpse_use_timeout", 10); // default is 5000 (5 * 1000)
    m_min_sleep_time = 1000 * READ_IF_EXISTS(pSettings, r_u32, section, "min_sleep_time", 5); // default is 5000 (5 * 1000)
    m_min_life_time = 1000 * READ_IF_EXISTS(pSettings, r_u32, section, "min_life_time", 10); // default is 10000 (10 * 1000)
    m_drive_out_time = 1000 * READ_IF_EXISTS(pSettings, r_u32, section, "drive_out_time", 5); // default is 10000 (10 * 1000)
    min_move_dist = READ_IF_EXISTS(pSettings, r_u32, section, "min_move_dist", 4);
    max_move_dist = READ_IF_EXISTS(pSettings, r_u32, section, "max_move_dist", 6);
