...
void CAI_Bloodsucker::Load(LPCSTR section)
{
    ...
    m_sufficient_hits_before_vampire_random = -1 + Random.randI(3);
...
{
    bool is_critical = Random.randF() <= m_critical_hit_chance;
...
void CAI_Bloodsucker::force_stand_sleep_animation(u32 index) { anim().set_override_animation(eAnimSleepStanding, index); }
