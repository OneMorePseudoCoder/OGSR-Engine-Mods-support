...
CStateManagerPsyDog::CStateManagerPsyDog(CAI_PseudoDog* monster) : inherited(monster) { add_state(eStateAttack_Psy, xr_new<CStatePsyDogPsyAttack<CAI_PseudoDog>>(monster)); }
