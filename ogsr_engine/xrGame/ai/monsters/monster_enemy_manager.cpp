...
size_t CMonsterEnemyManager::get_enemies_count() const { return monster->EnemyMemory.get_enemies_count(); }
...
bool CMonsterEnemyManager::see_enemy_now() const { return monster->memory().visual().visible_right_now(enemy); }

bool CMonsterEnemyManager::see_enemy_now(const CEntityAlive* enemy) const { return monster->memory().visual().visible_right_now(enemy); }

bool CMonsterEnemyManager::see_enemy_recently() const { return see_enemy_recently(enemy); }

bool CMonsterEnemyManager::see_enemy_recently(const CEntityAlive* enemy) const { return monster->memory().visual().visible_now(enemy); }
...
bool CMonsterEnemyManager::is_enemy(const CEntityAlive* obj) const { return ((monster->g_Team() != obj->g_Team()) && monster->is_relation_enemy(obj) && obj->g_Alive()); }
...
u32 CMonsterEnemyManager::see_enemy_duration() const { return ((m_time_start_see_enemy == 0) ? 0 : (time() - m_time_start_see_enemy)); }
