...
bool CAI_Stalker::throw_check_error(float low, float high, const Fvector& position, const Fvector& velocity, const Fvector& gravity) { return true; }
...
void CAI_Stalker::check_throw_trajectory(const float& throw_time)
{
    ...
    if (!trajectory_intersects_geometry(throw_time, m_throw_position, m_throw_target_position, m_throw_velocity, m_throw_collide_position, this, m_throw_ignore_object, rq_storage,
                                        trajectory_picks, collide_tris, box_size))
    {
