...
void CUIGameSP::ChangeLevel(GameGraph::_GRAPH_ID game_vert_id, u32 level_vert_id, Fvector pos, Fvector ang, Fvector pos2, Fvector ang2, bool b_use_position_cancel,
...
bool CUIGameSP::FillDebugTree(const CUIDebugState& debugState)
{
    ...
    const bool open = ImGui::TreeNodeEx("CUIGameSP", flags, "Game UI (%s)", CUIGameSP::GetDebugType());
