...
void CTorch::script_register(lua_State* L)
{
    module(L)[(class_<CTorch, CGameObject /*CInventoryItemObject*/>("CTorch")
               ...
               ,
           def("get_torch_obj", [](CScriptGameObject* script_obj) { return smart_cast<CTorch*>(&script_obj->object()); }), class_<CPda, CGameObject>("CPda").def(constructor<>()),
              class_<CScientificDetector, CGameObject>("CScientificDetector").def(constructor<>()), class_<CEliteDetector, CGameObject>("CEliteDetector").def(constructor<>()),
              class_<CAdvancedDetector, CGameObject>("CAdvancedDetector").def(constructor<>()), class_<CSimpleDetector, CGameObject>("CSimpleDetector").def(constructor<>()))];
}
