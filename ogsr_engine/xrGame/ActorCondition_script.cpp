...
static void BoosterForEach(CActorCondition* conditions, const luabind::functor<bool>& funct)
{
...
static bool ApplyBooster_script(CActorCondition* cond, const SBooster& B, LPCSTR sect) { return cond->ApplyBooster(B, sect); }

static void ClearAllBoosters(CActorCondition* conditions)
{
    CEntityCondition::BOOSTER_MAP& cur_booster_influences = conditions->GetCurBoosterInfluences();
    CEntityCondition::BOOSTER_MAP::const_iterator it = cur_booster_influences.begin();
    CEntityCondition::BOOSTER_MAP::const_iterator it_e = cur_booster_influences.end();
...
static void WoundForEach(CActorCondition* conditions, const luabind::functor<bool>& funct)
{
    ...
    module(
        L)[class_<SBooster>("SBooster")
           ...
           class_<CEntityCondition>("CEntityCondition")
               ...
               .enum_("EBoostParams")
                   [value("eBoostHpRestore", int(EBoostParams::eBoostHpRestore)), value("eBoostPowerRestore", int(EBoostParams::eBoostPowerRestore)),
                    value("eBoostRadiationRestore", int(EBoostParams::eBoostRadiationRestore)), value("eBoostBleedingRestore", int(EBoostParams::eBoostBleedingRestore)),
                    value("eBoostThirstRestore", int(EBoostParams::eBoostThirstRestore)), value("eBoostSatietyRestore", int(EBoostParams::eBoostSatietyRestore)),
                    value("eBoostAlcoholRestore", int(EBoostParams::eBoostAlcoholRestore)),

                    value("eBoostMaxWeight", int(EBoostParams::eBoostMaxWeight)), value("eBoostRadiationProtection", int(EBoostParams::eBoostRadiationProtection)),
                    value("eBoostTelepaticProtection", int(EBoostParams::eBoostTelepaticProtection)),
                    value("eBoostChemicalBurnProtection", int(EBoostParams::eBoostChemicalBurnProtection)), value("eBoostBurnImmunity", int(EBoostParams::eBoostBurnImmunity)),
                    value("eBoostShockImmunity", int(EBoostParams::eBoostShockImmunity)), value("eBoostRadiationImmunity", int(EBoostParams::eBoostRadiationImmunity)),
                    value("eBoostTelepaticImmunity", int(EBoostParams::eBoostTelepaticImmunity)),
                    value("eBoostChemicalBurnImmunity", int(EBoostParams::eBoostChemicalBurnImmunity)), value("eBoostExplImmunity", int(EBoostParams::eBoostExplImmunity)),
                    value("eBoostStrikeImmunity", int(EBoostParams::eBoostStrikeImmunity)), value("eBoostFireWoundImmunity", int(EBoostParams::eBoostFireWoundImmunity)),
           ...
           class_<CActorCondition, CEntityCondition>("CActorCondition")
               ...
               .def("GetAlcohol", &CActorCondition::GetAlcohol)
               ...
               .enum_("condition_flags")
                   [value("eCriticalPowerReached", int(CActorCondition::eCriticalPowerReached)), value("eCriticalBleedingSpeed", int(CActorCondition::eCriticalBleedingSpeed)),
                    value("eCriticalSatietyReached", int(CActorCondition::eCriticalSatietyReached)),
                    value("eCriticalRadiationReached", int(CActorCondition::eCriticalRadiationReached)), value("eWeaponJammedReached", int(CActorCondition::eWeaponJammedReached)),
                    value("ePsyHealthMinReached", int(CActorCondition::ePsyHealthMinReached)), value("eCantWalkWeight", int(CActorCondition::eCantWalkWeight))]];
}