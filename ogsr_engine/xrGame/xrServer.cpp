...
void xrServer::SendTo_LL(ClientID, void* data, u32 size, u32, u32) { Level().OnMessage(data, size); }
...
shared_str xrServer::level_version(const shared_str& server_options) const { return (game_sv_GameState::parse_level_version(server_options)); }
