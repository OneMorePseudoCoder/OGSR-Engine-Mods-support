...
void dbg_draw_viewport(const T& cam_info, float _viewport_near)
{
    ...
    float h_w, h_h;
    viewport_size(Device, _viewport_near, cam_info, h_w, h_h);
...
void CActor::cam_Update(float dt, float fFOV)
{
    ...
    {
        extern float psHUD_FOV, psHUD_FOV_def;
    ...
    Fvector point{0.f, CurrentHeight + current_ik_cam_shift, 0.f}, dangle{};
    Fmatrix xform;
