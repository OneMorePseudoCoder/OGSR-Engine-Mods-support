...
struct HUD_SOUND_ITEM
{
    ...
    static void PlaySound(HUD_SOUND_ITEM& snd, const Fvector& position, const CObject* parent, bool hud_mode, bool looped = false, bool overlap = false, u8 index = u8(-1));
...
public:
    ...
    void PlaySound(LPCSTR alias, const Fvector& position, const CObject* parent, bool hud_mode, bool looped = false, bool overlap = false, u8 index = u8(-1));
