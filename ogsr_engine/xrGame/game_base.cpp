...
CLASS_ID game_GameState::getCLASS_ID(LPCSTR game_type_name, bool isServer)
{
    ...
    switch (gameID)
    {
    case eGameIDSingle: return isServer ? make_clsid("SV_SINGL") : make_clsid("CL_SINGL");

    default: return (make_clsid("        "));
    }
}
...
u64 game_GameState::GetStartGameTime() { return (m_qwStartGameTime); }

ALife::_TIME_ID game_GameState::GetGameTime() // SIMP: Fixed! https://github.com/joye-ramone/NS_OGSR_Engine/commit/e2570023d1b228e37e93453603c0534942a459e4
{
...
float game_GameState::GetGameTimeFactor() // SIMP: Fixed! https://github.com/joye-ramone/NS_OGSR_Engine/commit/e2570023d1b228e37e93453603c0534942a459e4
{
    if (ai().get_alife() && ai().alife().initialized())
