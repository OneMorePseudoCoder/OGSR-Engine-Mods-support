...
void loophole_action_base::process_default(bool const& change_sight)
{
    ...
    VERIFY(object().movement().current_params().cover_loophole());
...
void loophole_action::initialize()
{
    ...
    m_animation = animations[Random.randI(animations.size())];
}
...
transition::transition(CAI_Stalker* object, LPCSTR action_name, LPCSTR action_from, LPCSTR action_to, StalkerDecisionSpace::EWorldProperties state_from,
    ...
    : inherited(object, action_name), m_action_from(action_from), m_action_to(action_to), m_state_from(state_from), m_state_to(state_to), m_planner(planner)
{}
...
idle_2_fire_transition::idle_2_fire_transition(CAI_Stalker* object, LPCSTR action_name, LPCSTR action_from, LPCSTR action_to, StalkerDecisionSpace::EWorldProperties state_from,
...
fire_2_idle_transition::fire_2_idle_transition(CAI_Stalker* object, LPCSTR action_name, LPCSTR action_from, LPCSTR action_to, StalkerDecisionSpace::EWorldProperties state_from,
                                               StalkerDecisionSpace::EWorldProperties state_to, animation_planner* planner)
    : inherited(object, action_name, action_from, action_to, state_from, state_to, planner)
{}
...
idle_2_lookout_transition::idle_2_lookout_transition(CAI_Stalker* object, LPCSTR action_name, LPCSTR action_from, LPCSTR action_to,
