...
void CArtefact::Interpolate() { return; }
...
SArtefactDetectorsSupport::SArtefactDetectorsSupport(CArtefact* A) : m_parent(A), m_currPatrolPath(nullptr), m_currPatrolVertex(nullptr), m_switchVisTime(0) {}
