...
IC void stalker_movement_manager_base::set_head_orientation(const MonsterSpace::SBoneRotation& orientation) { m_head = orientation; }

IC void stalker_movement_manager_base::set_desired_direction(Fvector const* direction) { m_target.desired_direction(direction); }

IC void stalker_movement_manager_base::add_velocity(int mask, float linear, float compute_angular) { add_velocity(mask, linear, compute_angular, compute_angular); }
...
IC void stalker_movement_manager_base::set_movement_type(EMovementType movement_type) { m_target.m_movement_type = movement_type; }
...
IC void stalker_movement_manager_base::set_detail_path_type(EDetailPathType detail_path_type) { m_target.m_detail_path_type = detail_path_type; }

IC MonsterSpace::EBodyState const& stalker_movement_manager_base::body_state() const { return (m_current.m_body_state); }

IC MonsterSpace::EBodyState const& stalker_movement_manager_base::target_body_state() const { return (m_target.m_body_state); }

IC MonsterSpace::EMovementType const& stalker_movement_manager_base::movement_type() const { return (m_current.m_movement_type); }

IC MonsterSpace::EMentalState const& stalker_movement_manager_base::mental_state() const { return (m_current.m_mental_state); }

IC MonsterSpace::EMentalState const& stalker_movement_manager_base::target_mental_state() const { return (m_target.m_mental_state); }

IC MovementManager::EPathType const& stalker_movement_manager_base::path_type() const { return (m_current.m_path_type); }

IC DetailPathManager::EDetailPathType const& stalker_movement_manager_base::detail_path_type() const { return (m_current.m_detail_path_type); }
...
IC MonsterSpace::EMovementType const& stalker_movement_manager_base::target_movement_type() const { return (m_target.m_movement_type); }
