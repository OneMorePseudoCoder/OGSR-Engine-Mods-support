...
template <typename Class, typename ParametersTuple, typename DelegateType, void (Class::*method)(ParametersTuple const&, DelegateType),
...
public:
    ...
    queued_async_method() { pending_proxy_exec.bind_cpp(this, &queued_async_method::proxy_execution); }
    ~queued_async_method() {};
...
struct parameters_tuple3
{
    ...
    bool operator==(parameters_tuple3 const& right) const { return (m_t1 == right.m_t1) && (m_t2 == right.m_t2) && (m_t3 == right.m_t3); }
