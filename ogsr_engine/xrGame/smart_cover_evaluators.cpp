...
_value_type loophole_hit_long_ago_evaluator::evaluate() { return ((m_object->time_object_hit() + m_time_to_wait) < Device.dwTimeGlobal); }
...
_value_type default_behaviour_evaluator::evaluate() { return (m_object->m_object->movement().default_behaviour() || m_object->m_object->movement().combat_behaviour()); }
