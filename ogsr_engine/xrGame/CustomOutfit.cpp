...
void CCustomOutfit::OnH_A_Chield() { inherited::OnH_A_Chield(); }
...
float CCustomOutfit::GetDefHitTypeProtection(ALife::EHitType hit_type) { return m_HitTypeProtection[hit_type] * GetCondition(); }
