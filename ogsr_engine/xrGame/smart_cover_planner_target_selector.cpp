...
void target_selector::setup(animation_planner* object, CPropertyStorage* storage)
{
    ...
    CActionPlanner::m_storage.set_property(eWorldPropertyLookedOut, Random.randF() <= .7f ? true : false);
...
void target_selector::add_evaluators()
{
    ...
    add_evaluator(eWorldPropertyLoopholeTooMuchTimeFiring,
                  xr_new<CPropertyEvaluatorMember<animation_planner>>((CPropertyStorage*)0, eWorldPropertyLoopholeTooMuchTimeFiring, true, true, "too much time firing"));
