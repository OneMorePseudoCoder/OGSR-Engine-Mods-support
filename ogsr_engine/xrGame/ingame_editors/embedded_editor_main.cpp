...
CImGuiEditor::CImGuiEditor()
{
    ...
    CImGuiUIEditorWnd* ui_editor_wnd = xr_new<CImGuiUIEditorWnd>();
    ui_editor_wnd->m_Name = "UI Editor";
    m_Windows.push_back(ui_editor_wnd);

    CImGuiPropEditorWnd* prop_editor_wnd = xr_new<CImGuiPropEditorWnd>();
    prop_editor_wnd->m_Name = "Properties Editor";
    m_Windows.push_back(prop_editor_wnd);
...
void CImGuiEditor::RenderDockSpace()
{
    ...
    if (ImGui::DockBuilderGetNode(dockspace_id) == nullptr)
    {
        ...
        ImGui::DockBuilderDockWindow("UI Editor", dock_id_left_bottom);
        ImGui::DockBuilderDockWindow("Properties Editor", dock_id_left_bottom);
