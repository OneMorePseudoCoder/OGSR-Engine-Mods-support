...
{
    string256 full_name;
    m_fCameraMoveEpsilon = READ_IF_EXISTS(pSettings, r_float, Section, xr_strconcat(full_name, Prefix, "camera_move_epsilon"),
    ...
    m_fZoomAimingDispK = READ_IF_EXISTS(pSettings, r_float, Section, xr_strconcat(full_name, Prefix, "zoom_aim_disp_k"),
                                        pSettings->r_float(EFFECTOR_ZOOM_SECTION, "zoom_aim_disp_k"));
    m_fZoomAimingSpeedK = READ_IF_EXISTS(pSettings, r_float, Section, xr_strconcat(full_name, Prefix, "zoom_aim_speed_k"),
