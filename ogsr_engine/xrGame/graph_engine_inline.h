...
inline bool CGraphEngine::search(const _Graph& graph, const _index_type& start_node, const _index_type& dest_node, xr_vector<_index_type>* node_path, const _Parameters& parameters)
{
...
template <typename _Graph, typename _Parameters>
inline bool CGraphEngine::search(const _Graph& graph, const _index_type& start_node, const _index_type& dest_node, xr_vector<_index_type>* node_path, _Parameters& parameters)
{
    START_PROFILE("graph_engine")
    START_PROFILE("graph_engine/search")
    PathTimer.Begin();
...
inline bool CGraphEngine::search(const CProblemSolver<T1, T2, T3, T4, T5, T6, T7, T8>& graph, const _solver_index_type& start_node, const _solver_index_type& dest_node,
...
template <typename _Graph, typename _Parameters>
inline bool CGraphEngine::search(const _Graph& graph, const shared_str& start_node, const shared_str& dest_node, xr_vector<shared_str>* node_path, _Parameters& parameters)
{
    START_PROFILE("graph_engine")
    START_PROFILE("graph_engine/search")
    PathTimer.Begin();
    using CPathManagerGeneric = CPathManager<_Graph, CStringAlgorithm::CDataStorage, _Parameters, float, shared_str, u32>;
    CPathManagerGeneric path_manager;
