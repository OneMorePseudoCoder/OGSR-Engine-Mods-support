...
manager::manager(CAI_Stalker* object)
    : m_object(object), m_current_cover(0), m_target_cover(0), m_current_loophole(0), m_target_loophole(0), m_current_transition(0), m_cover_id(""), m_default_behaviour(false)
{
    VERIFY(object);
...
manager::transition_processor const& manager::transitions_processor() const { return (*m_transitions_processor); }