...
protected:
    ...
    Fvector GetPositionForCollision() override { return Device.vCameraPosition; }
    Fvector GetDirectionForCollision() override { return Device.vCameraDirection; }
...
private:
    ...
    static bool shapes_compare_predicate(victims_shapes_list_t::value_type const& left, victims_shapes_list_t::value_type const& right) { return left.second < right.second; }
