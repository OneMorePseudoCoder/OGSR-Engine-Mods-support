...
void CUILogsWnd::Init()
{
    ...
    AddCallback(m_filter_news, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUILogsWnd::UpdateChecks));
    AddCallback(m_filter_talk, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUILogsWnd::UpdateChecks));
    AddCallback(m_prev_period, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUILogsWnd::PrevPeriod));
    AddCallback(m_next_period, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUILogsWnd::NextPeriod));
