...
void CUIMapWnd::init_xml_nav(CUIXml& xml)
{
    ...
    AddCallback(m_btn_nav[btn_legend], BUTTON_DOWN, fastdelegate::MakeDelegate(this, &CUIMapWnd::OnBtnLegend_Push));
    //	AddCallback( m_btn_nav[btn_up]->WindowName(),			BUTTON_DOWN, fastdelegate::MakeDelegate( this, &CUIMapWnd::OnBtnUp_Push		) );
    AddCallback(m_btn_nav[btn_zoom_more], BUTTON_DOWN, fastdelegate::MakeDelegate(this, &CUIMapWnd::OnBtnZoomMore_Push));

    //	AddCallback( m_btn_nav[btn_left]->WindowName(),			BUTTON_DOWN, fastdelegate::MakeDelegate( this, &CUIMapWnd::OnBtnLeft_Push	) );
    AddCallback(m_btn_nav[btn_actor], BUTTON_DOWN, fastdelegate::MakeDelegate(this, &CUIMapWnd::OnBtnActor_Push));
    //	AddCallback( m_btn_nav[btn_right]->WindowName(),		BUTTON_DOWN, fastdelegate::MakeDelegate( this, &CUIMapWnd::OnBtnRight_Push	) );

    AddCallback(m_btn_nav[btn_zoom_less], BUTTON_DOWN, fastdelegate::MakeDelegate(this, &CUIMapWnd::OnBtnZoomLess_Push));
    //	AddCallback( m_btn_nav[btn_down]->WindowName(),			BUTTON_DOWN, fastdelegate::MakeDelegate( this, &CUIMapWnd::OnBtnDown_Push	) );
    AddCallback(m_btn_nav[btn_zoom_reset], BUTTON_DOWN, fastdelegate::MakeDelegate(this, &CUIMapWnd::OnBtnZoomReset_Push));
}
