...
void CUITaskWnd::Init()
{
    ...
    AddCallback(m_cbTreasures, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUITaskWnd::OnShowTreasures));
    ...
    AddCallback(m_cbPrimaryObjects, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUITaskWnd::OnShowPrimaryObjects));
    ...
    AddCallback(m_cbSecondaryTasks, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUITaskWnd::OnShowSecondaryTasks));
    m_bSecondaryTasksEnabled = true;

    m_cbQuestNpcs = UIHelper::CreateCheck(xml, "filter_quest_npcs", this);
    m_cbQuestNpcs->SetCheck(true);
    AddCallback(m_cbQuestNpcs, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUITaskWnd::OnShowQuestNpcs));
    ...
    AddCallback(m_pStoryLineTaskItem, WINDOW_LBUTTON_DB_CLICK, fastdelegate::MakeDelegate(this, &CUITaskWnd::OnTask1DbClicked));

    m_btn_focus = UIHelper::Create3tButton(xml, "btn_task_focus", this);
    Register(m_btn_focus);
    AddCallback(m_btn_focus, BUTTON_DOWN, fastdelegate::MakeDelegate(this, &CUITaskWnd::OnTask1DbClicked));

    m_BtnTaskListWnd = UIHelper::Create3tButton(xml, "btn_second_task", this);
    AddCallback(m_BtnTaskListWnd, BUTTON_CLICKED, fastdelegate::MakeDelegate(this, &CUITaskWnd::OnShowTaskListWnd));
...
void CUITaskWnd::ReloadTaskInfo()
{
    ...
    for (; b != e; b++)
    {
        ...
        else if (spot == "ui_pda2_trader_location" || spot == "ui_pda2_mechanic_location" || spot == "ui_pda2_scout_location" || spot == "ui_pda2_quest_npc_location" ||
                 spot == "ui_pda2_medic_location" || spot == "ui_pda2_actor_box_location" || spot == "ui_pda2_actor_sleep_location")
