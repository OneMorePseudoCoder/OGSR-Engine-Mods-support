...
CUIDragDropListEx::CUIDragDropListEx()
{
    ...
    AddCallbackStr("scroll_v", SCROLLBAR_VSCROLL, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnScrollV));
    AddCallbackStr("cell_item", DRAG_DROP_ITEM_DRAG, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemStartDragging));
    AddCallbackStr("cell_item", DRAG_DROP_ITEM_DROP, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemDrop));
    AddCallbackStr("cell_item", DRAG_DROP_ITEM_SELECTED, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemSelected));
    AddCallbackStr("cell_item", DRAG_DROP_ITEM_LBUTTON_CLICK, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemLButtonClick));
    AddCallbackStr("cell_item", DRAG_DROP_ITEM_RBUTTON_CLICK, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemRButtonClick));
    AddCallbackStr("cell_item", DRAG_DROP_ITEM_DB_CLICK, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemDBClick));
    AddCallbackStr("cell_item", DRAG_DROP_ITEM_FOCUSED_UPDATE, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemFocusedUpdate));
    AddCallbackStr("cell_item", WINDOW_FOCUS_RECEIVED, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemFocusReceived));
    AddCallbackStr("cell_item", WINDOW_FOCUS_LOST, fastdelegate::MakeDelegate(this, &CUIDragDropListEx::OnItemFocusLost));
...
void CUIDragDropListEx::OnScrollV(CUIWindow* w, void* pData) { m_container->SetWndPos(Fvector2().set(m_container->GetWndPos().x, float(-m_vScrollBar->GetScrollPos()))); }
...
Ivector2 CUICellContainer::TopVisibleCell() { return Ivector2().set(0, iFloor(m_pParentDragDropList->ScrollPos() / float(CellSize().y + m_cellSpacing.y))); }
