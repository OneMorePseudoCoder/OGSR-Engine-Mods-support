...
void UIArtefactParamItem::SetValue(float value)
{
    ...
    const bool positive = m_sign_inverse ? ::negative(value) : ::positive(value);
    m_value->SetTextColor(positive ? green_clr : red_clr);
