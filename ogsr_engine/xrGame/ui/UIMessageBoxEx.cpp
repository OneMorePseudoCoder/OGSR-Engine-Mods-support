...
void CUIMessageBoxEx::InitMessageBox(LPCSTR xml_template)
{
    ...
    AddCallback(m_pMessageBox, MESSAGE_BOX_YES_CLICKED, fastdelegate::MakeDelegate(this, &CUIMessageBoxEx::OnOKClicked));
    ...
    if (style == CUIMessageBox::MESSAGEBOX_YES_NO || style == CUIMessageBox::MESSAGEBOX_QUIT_WINDOWS || style == CUIMessageBox::MESSAGEBOX_QUIT_GAME)
        AddCallback(m_pMessageBox, MESSAGE_BOX_NO_CLICKED, fastdelegate::MakeDelegate(this, &CUIMessageBoxEx::OnNOClicked));
}
