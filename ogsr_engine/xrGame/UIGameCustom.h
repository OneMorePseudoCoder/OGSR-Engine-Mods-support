...
protected:
    CUIWindow* m_window;
    CUIXml* m_msgs_xml;
    typedef xr_vector<StaticDrawableWrapper*> st_vec;
...
public:
    ...
    StaticDrawableWrapper* AddCustomStatic(LPCSTR id, bool bSingleInstance);
    StaticDrawableWrapper* GetCustomStatic(LPCSTR id);
