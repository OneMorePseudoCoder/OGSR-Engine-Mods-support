...
stalker_movement_params::stalker_movement_params()
    : m_manager(0), m_body_state(MonsterSpace::eBodyStateStand), m_movement_type(MonsterSpace::eMovementTypeStand), m_mental_state(MonsterSpace::eMentalStateDanger),
      m_path_type(MovementManager::ePathTypeNoPath), m_detail_path_type(DetailPathManager::eDetailPathTypeSmooth),
